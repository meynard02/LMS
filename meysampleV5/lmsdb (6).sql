...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2025 at 09:49 AM
...
(1, 'Alrashid', 'Rojas', 'c22-4810-01@spist.edu.ph', 'admin', '$2y$10$Z5DvGy1pnFObA5xg41klf.IoI.ADYxsC.Uekjv.jk5bk0Jd.TNgtS', 'Active'),
(2, 'Meynard', 'Ocenar', 'c22-4757-01@spist.edu.ph', 'admin1', '$2y$10$lmHB2gXkM7pubDuGZgiVm.zrGxYjnHDDdsOSZR7yK7mI9jhWhE7.2', 'Inactive'),
...
(5, 'Mello', 'Delleva', 'c22-4566-01@spist.edu.ph', 'mellodapdap', '$2y$10$MBjfv7gokGunIa37c0KNb.gc2rVKVZADZvzf6tDHOI6mu9arLnNuu', 'Active');
...
(123, 'Java', 'Meymey', 1, '67f9d84c0c0ed.jpg', 'Sakit sa ulo', '2004', 'Checked Out'),
...
(126, 'English12', 'Shid', 1, '67fbee1fdf096.PNG', 'Bisayang English', '0000', 'Checked Out'),
(127, 'History10', 'Asher', 1, '67fc0d6e756b7.jpg', 'Kapagod', '0000', 'On Hold'),
...
(445, 'gusiom', 'mellogwpas', 1, '680c78a1376c9.png', 'tralala tralili', '0000', 'Available');
...
(1, 'spistlms@gmail.com', '09098835592');
...
(52, 'c22-4757-01@spist.edu.ph', 'Meymey', 'Ocenar', '$2y$10$GWwWegMYW0pW.VG9MdDiDe5YJ.h9HT1nTOj4h/iLx58EBlkHMk7Km', 0, '2025-05-09 05:20:42', 1, 'Suspended'),
...
(90, 'c22-4810-01@spist.edu.ph', 'Shid', 'Rojas', '$2y$10$Us6YLUPL5bVf0ZSp9mb3y.ZLF570htB2OVXUtumoWr/BgVSpRu50S', 543584, '2025-05-09 05:20:03', 1, 'Active'),
(93, '123@spist.edu.ph', 'shid', 'rojas', '$2y$10$RYUtdqxSg9ISB2lCxI5tce4PCx.4QCVW6lVm65PQPLNuwCUPuyyie', 412224, '2025-05-09 05:48:09', 0, 'Pending');
...
--
ALTER TABLE `book_categories`
  MODIFY `Book_CategoryID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `transaction`
  MODIFY `transactionID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
