...
try {
    ...
    if ($action === 'add') {
        ...
        $stmt = $conn->prepare("INSERT INTO book (AccessionNo, Title, Author, Book_CategoryID, Photo, Description, Availability, created_at) 
                              VALUES (?, ?, ?, ?, ?, ?, ?, NOW())");
    ...
    elseif ($action === 'update') {
        ...
        // Update existing book (no need to update created_at)
        if ($photo) {
