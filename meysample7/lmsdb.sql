...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 08, 2025 at 10:17 AM
...
INSERT INTO `admin` (`AdminID`, `AdminFName`, `AdminLName`, `AdminEmail`, `AdminUsername`, `AdminPassword`, `Status`, `created_at`, `AdminOTP`, `otp_expiry`) VALUES
...
(9, 'Mey', 'Ocenar', 'c22-4757-01@spist.edu.ph', 'admin1', '$2y$10$QKM6V9JMIPCRYGg3.Tx5WeY7pBFnifDb4YtcapLz3PqOmhed6cfaG', 'Active', '2025-05-10 02:09:16', NULL, NULL),
(10, 'Sam', 'Santos', 'c22-4629-01@spist.edu.ph', 'admin2', '$2y$10$axIn4a7y0.T.x0WDAS1rD.pR/ELe8mBRPk2wsC2C9JOeXL7R/iMVy', 'Active', '2025-05-10 02:10:12', NULL, NULL);
...
(124, 'C++', 'Meynard Ocenar', 1, '67f9e9b3c8cb5.jpg', 'for programming', '2003', 'Checked Out', '2025-05-09 09:16:24'),
...
(94, 94, 124, 3, '2025-05-14 16:00:00', '2025-05-25 00:00:00', NULL, 1);
...
(94, 'c22-4810-01@spist.edu.ph', 'Alrashid', 'Rojas', '$2y$10$6TMrq2701f3ZwW0W/Q16V.o.x4nGTJjW3Kf4iP77GkJqj4XPNkhSa', 0, '2025-05-10 06:01:12', 1, 'Active');
...
--
ALTER TABLE `admin`
  MODIFY `AdminID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `transaction`
  MODIFY `transactionID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
