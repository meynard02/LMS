            ...
            <div class="book-modal-content">
                ...
                <div class="book-modal-right">
                    ...
                    <div class="book-meta">
                        ...
                        <span class="book-genre" id="modal-book-genre"><i class="fas fa-tag"></i> Genre</span>
                    </div>
                    ...
                    <div class="book-details">
                        ...
                        <div class="details-grid">
                            <div class="detail-item">
                                <span class="detail-label"><i class="fas fa-calendar-alt"></i> Published:</span>
                                <span class="detail-value" id="modal-book-year">2023</span>
                            </div>
                            <div class="detail-item">
                                <span class="detail-label"><i class="fas fa-file-alt"></i> Pages:</span>
                                <span class="detail-value" id="modal-book-pages">320</span>
                            </div>
                            <div class="detail-item">
                                <span class="detail-label"><i class="fas fa-language"></i> Language:</span>
                                <span class="detail-value" id="modal-book-language">English</span>
                            </div>
                            <div class="detail-item">
                                <span class="detail-label"><i class="fas fa-barcode"></i> ISBN:</span>
                                <span class="detail-value" id="modal-book-isbn">978-3-16-148410-0</span>
                            </div>
                        </div>
                    </div>
                </div>
